                          ...
                          {variants.length === 0 ? (
                            ...
                            <div className="flex flex-col gap-2">
                              {variants.map((v: any) => {
                                ...
                                const vImg = images.find((i: any) => i.variant_id === v.id)
                                return (
                                  <div key={v.id} className="bg-white rounded-lg border border-gray-200 p-2.5">
                                    <div className="flex items-center justify-between mb-2">
                                      <div className="flex items-center gap-2">
                                        {vImg ? (
                                          <img src={vImg.url} alt="variant" className="w-8 h-8 object-cover rounded shadow-sm border border-gray-100" />
                                        ) : (
                                    ...
                                    return (
                                      <div key={v.id} className="bg-white rounded-lg border border-gray-200 p-3">
                                        <div className="flex items-center justify-between mb-2">
                                          <div className="flex items-center gap-3">
                                            {vImg ? (
                                              <img src={vImg.url} alt="variant" className="w-10 h-10 object-cover rounded shadow-sm border border-gray-100" />
                                            ) : (
